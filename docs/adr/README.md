...
| ADR | Topic | Status |
|---|---|---|
| [0001](0001-eclipse-supabase-data-model.md) | Supabase data model: tables, roles, the DM reads and never writes | Accepted, amended by 0002 to 0009 |
...
| [0004](0004-scale-and-data-preservation.md) | One campaign of about a dozen; never lose a character; history snapshots | Accepted |
